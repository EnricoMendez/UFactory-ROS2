...
class move_line(Node):
    ...
    def square_routine(self):
        first_position = [300.0, 50.0, 90.0, 3.14, 0.0, 0.0]
        second_position = [300.0, -50.0, 90.0, 3.14, 0.0, 0.0]
        third_position = [250.0, -50.0, 90.0, 3.14, 0.0, 0.0]
        fourth_position = [250.0, 50.0, 90.0, 3.14, 0.0, 0.0]
        self.send_request(pose=first_position)
        self.send_request(pose=second_position)
        self.send_request(pose=third_position)
        self.send_request(pose=fourth_position)
